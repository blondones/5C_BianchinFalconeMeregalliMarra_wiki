...
<body>
    ...
    <div class="content-area">
        ...
        <?php 
                ...
                //crea la variabile di sessione per l'articolo
                $_SESSION["articoloContainer"] = $articoloContainer;
                //viene fatto il salvataggio dell'articolo quindi adesso bisogna andare in reviewrer_approveBozze.php, riprendere 
                //la session di aricoloContainer e cambiarne il contenuto con il testo della bozza accettata
                //e poi fare il redirect alla home.php (possibilmente cambiandone l'articolo)
        }
        ?>
    </div>
